...
public class GeeTestSDK {
    ...
    public int preProcess() {
        ...
        if (registerChallenge() != 1) {
            ...
            this.responseValue = this.getFailPreProcessRes();
            return 0;
        }
    ...
    private int registerChallenge() {
        try {
            ...
            if (32 == result_str.length()) {
                ...
                this.responseValue = this.getSuccessPreProcessRes(this.md5Encode(result_str + this.privateKey));
    ...
    public int enhencedValidateRequest(String challenge, String validate, String secCode) {
         ...
         */
        if (ObjectUtils.isEmpty(challenge) || ObjectUtils.isEmpty(validate) || ObjectUtils.isEmpty(secCode)) {
            return 0;
        }
