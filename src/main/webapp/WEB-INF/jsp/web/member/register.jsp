...
<div class="user">
    <div><span><img src="../../../img/user/p1.png"></span><input class="pic" type="text" name="" placeholder="用户名">
    </div>
    <div><span><img src="../../../img/user/p4.png"></span><input class="pic" type="email" name="" placeholder="邮箱">
    </div>
    <div><span><img src="../../../img/user/p2.png"></span><input class="pic" type="password" name="" placeholder="密码">
    </div>
    <div><span><img src="../../../img/user/p2.png"></span><input class="pic" type="password" name=""
                                                                 placeholder="再次确认密码"></div>
